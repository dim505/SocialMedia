...
namespace SocialMedia.Controller
{
    ...
    public class PeopleController : ControllerBase
    {
        ...
        public IActionResult FindPeople()
        {
            ...
            {
                string SqlStr = @"exec FindPeople @LoggedInUser";
                findPeoples = db.Query<FindPeople>(SqlStr, new
                {
        ...
        public IActionResult GetCircle()
        {
            ...
            using (IDbConnection db = new SqlConnection(ConnStr))
            {
                ...
                yourCircle = db.Query<YourCircle>(SqlStr, new
                {
                    FollwerAuth0ID = new DbString
                    {
                        Value = LoggedInUser,
                        IsFixedLength = false,
                        IsAnsi = true
